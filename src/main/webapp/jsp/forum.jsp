...
<div class="super_container">
    ...
    <div class="forum_function">
        ...
        <button class="layui-btn layui-btn-primary layui-btn-sm" name="发帖" onclick="javascript:window.location.href='jsp/forum_add.jsp'">
                ...
                <div class="span8 main-listing">
                    ...
                    <div id="pagination">
                        <c:forEach begin="1" end="${page.totalPage}" var="currPage">
                            <a href="forum/findList?currPage=${currPage}" <c:if test="${page.currPage == currPage}">class="btn active"</c:if> >${currPage}</a>
                        </c:forEach>
                    </div>
