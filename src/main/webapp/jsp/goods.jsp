			...
			<div class="row page_num_container">
				<div class="col text-right">
					...
					<c:forEach begin="1" end="${page.totalPage}" var="currPage">
						<li <c:if test="${page.currPage == currPage}">class="active"</c:if> > <a href="goods/findGoodList?currPage=${currPage}">${currPage}</a>
						</li>
					</c:forEach>
					</ul>
				</div>
...
<script>
	...
	function search() {
     	...
     	console.log(123);
		document.location.href="goods/searchByName?searchString="+searchString;
	}
</script>
