                ...
                <div class="col">
                    <div class="reviews">
                        <div class="current_page">
                            <ul>
                                <li><a href="jsp/add_activity.jsp">发起活动</a></li>
                                <li><a href="activity/myJoinActivity">我报名的</a></li>
                                <li><a href="activity/myActivity">我发起的</a></li>
                            </ul>
                        </div><br><br><br>
                        <div class="reviews_title">My Join</div>

                        <div class="reviews_container">
                            <ul>
                                <!-- Review -->
                                <c:forEach items="${activityJoinList}" var="aj">
                                    <li class=" review clearfix">
                                        <a href="join_activity.jsp"><div class="review_image"><img src="images/baoming.jpg" /></div></a>
                                        <div class="review_content">
                                            <div class="review_name">
                                                <a>${aj.activityName}&nbsp;&nbsp;
                                                    <c:if test="${aj.state==0}">[报名未通过]</c:if>
                                                    <c:if test="${aj.state==1}">[报名已通过]</c:if>
                                                </a>
                                            </div>
                                            <div class="review_date">活动地点：${aj.activityAddress}</div>
                                            <div class="review_text">
                                                <p>${aj.activityContent}</p>
                                            </div>
                                        </div>
                                    </li>
                                </c:forEach>
