			...
			<div class="row">
				<div class="col">
					<div class="review_form_container">
						<div class="review_form_title">活动发布</div>
						<div class="review_form_content">
							<form action="activity/add" id="review_form" class="review_form" method="post">
								<div class="d-flex flex-md-row flex-column align-items-start justify-content-between">
									<input type="text" class="review_form_input" placeholder="活动名称" required="required" name="name">
									<select class="review_form_input" id="categoryList" name="category"></select>
									<input type="text" class="review_form_input" placeholder="活动地点" name="address">
								</div>
								<textarea class="review_form_text" name="content" placeholder="活动内容"></textarea>
