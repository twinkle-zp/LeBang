                    ...
                    <div class="review_content">
                        <div class="review_name">
                            ...
                            <div class="review_download">
                                <button type="button" class="layui-btn" style="margin-left: 400px" onclick="window.location.href='resource/download?id=${p.id}&address=${p.address}&name=${p.name}${p.suffix}'">下载</button>
                            </div>
                        </div>
        ...
        <div class="col text-right">
            <ul class="page_nums">
                <c:forEach begin="1" end="${page.totalPage}" var="currPage">
                    <li <c:if test="${page.currPage == currPage}">class="active"</c:if> > <a href="resource/findList?currPage=${currPage}">${currPage}</a>
                    </li>
                </c:forEach>
            </ul>
        </div>
