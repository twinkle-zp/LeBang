...
<body>
    <!-- 顶部开始 -->
    <div class="container">
        <div class="logo"><a href="index.jsp">LeBang</a></div>
        <div class="left_open">
      ...
      <div id="side-nav">
        <ul id="nav">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="forum/findAllList">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>帖子列表</cite>
                        </a>
                    </li >
                    <li>
                        <a _href="forum/findAllType">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>类别列表</cite>
                        </a>
                    </li >
        ...
        <div class="layui-tab tab" lay-filter="xbs_tab" lay-allowclose="false">
          ...
          <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <iframe src='goods/findAllList' frameborder="0" scrolling="yes" class="x-iframe"></iframe>
            </div>
          </div>
          <div id="tab_show"></div>
        </div>
